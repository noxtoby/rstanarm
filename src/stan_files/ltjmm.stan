...
data {
  ...
  //   bK1_idx, bN2, bK2, bK2_len, bK2_idx, lt_idx
#include /data/dimensions_ltjmm.stan
...
#include /parameters/parameters_ltjmm.stan
}
...
#include /model/priors_ltjmm.stan
}
